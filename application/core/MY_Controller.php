...
class MY_Controller extends CI_Controller {
	...
	public function __construct() {
		...
		$client_id = '865947375019-h7rhr9m652q03eg8f5mrfco2q91t6huf.apps.googleusercontent.com';
		$client_secret = 'mMrRcPd7Xu2T4pso7dR6qqMM';
		$redirect_uri = base_url();
		$simple_api_key = 'AIzaSyC0QBteTjw4mU0gmCj9mvCdtqDPdoeBZXk';
		
		// Create Client Request to access Google API
		$client = new Google_Client();
		$client->setApplicationName("CMA Stock Market Game");
